...
//     + '<input class="password" pattern=".{8,}" title="8 characters minimum" type="password" name="password"'
//     + 'style="width:100%;min-width:0" required></td></tr><tr><td><p"><span style="color:red">*</span><i>Required field</i></p></td>'
